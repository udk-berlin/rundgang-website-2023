...
export default function LandingMenuL({ setInfoIsActive, setLinkClicked }) {
  const language = useIntl();
  return (
    <MenuContainer>
      <SVGContainer>
        {language.locale === "en" ? (
          <EnSVG setInfoIsActive={setInfoIsActive} setLinkClicked={setLinkClicked}/>
        ) : (
          <DeSVG setInfoIsActive={setInfoIsActive} setLinkClicked={setLinkClicked}/>
        )}
      </SVGContainer>
    </MenuContainer>
  );
...
function DeSVG({ setInfoIsActive, setLinkClicked }) {
    ...
    >
      ...
      <g>
        <StyledPath
          ...
          d="M8439.0752,1450.6074h-306.0997v-173.1376h306.0997v173.1376Z"
        />
        <StyledPath
          className="info"
          isHovered={isInfoHovered}
      ...
      <StyledRect
        width="8030"
        height="749.9098"
        onMouseEnter={() => setProgramIsHovered(true)}
        onMouseLeave={() => setProgramIsHovered(false)}
        ref={programRef}
      />
      <StyledRect
        y="846.7141"
        width="3198.7325"
        height="601.2173"
        onMouseEnter={() => setLocationsIsHovered(true)}
        onMouseLeave={() => setLocationsIsHovered(false)}
        ref={locationsRef}
      />
      <StyledRect
        x="3380.45"
      ...
      <StyledRect
        ...
        width="1450.6074"
        height="321.883"
        transform="translate(7562.3956 9013.003) rotate(-90)"
...
function EnSVG({ setInfoIsActive, setLinkClicked }) {
  const [isProgramHovered, setProgramIsHovered] = useState(false);
  const [isInfoHovered, setInfoIsHovered] = useState(false);
  const [isLocationsHovered, setLocationsIsHovered] = useState(false);
  const [isTimelineHovered, setTimelineIsHovered] = useState(false);
    ...
    >
      ...
      >
        ...
        <StyledPath
          className="timeline"
          isHovered={isTimelineHovered}
          d="M2131.3545,1351.6513v-341.7027h187.9365v341.7027h-187.9365Z"
        />
        <StyledPath
          className="timeline"
          isHovered={isTimelineHovered}
      ...
      <StyledRect
        ...
        width="1356.9904"
        height="301.1098"
        transform="translate(7620.3231 8977.3135) rotate(-90)"
        onMouseEnter={() => setInfoIsHovered(true)}
        onMouseLeave={() => setInfoIsHovered(false)}
        ref={infoRef}
      />
