...
const LOCATION_ID_TO_LNG_LAT = {
  '!PsyURUpKAbSPistHpQ:content.udk-berlin.de': {lng: 13.3290, lat: 52.5098},
  ...
  '!XGSFQYZUnFtQNzOBnD:content.udk-berlin.de': {lng: 13.327300406397331, lat: 52.50967152502669},
  '!GFauydmVRlpqvDETXH:content.udk-berlin.de': {lng: 13.3588243, lat: 52.4908045},
  //'!cUpdRzxCGmLkwfrUeq:content.udk-berlin.de': {lng: 13.32859, lat: 52.50939},
  '!eVjUBtkIgDQkQSKVxm:content.udk-berlin.de': {lng: 13.329011660461106, lat: 52.513815995810795},
  //'!fwsuOeorRCZtTqwukc:content.udk-berlin.de': {lng: 13.323453006016974, lat: 52.511295526569526},
  '!OkEblSLtaWAObRcCHm:content.udk-berlin.de': {lng: 13.332849698118526, lat: 52.49982823444154},
